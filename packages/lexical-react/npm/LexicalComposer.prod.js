...
exports.LexicalComposer=function({initialConfig:a,children:c}){let b=g.useMemo(()=>{const {theme:d,namespace:k,editor__DEPRECATED:u,nodes:v,onError:w,editorState:x,html:y}=a,z=e.createLexicalComposerContext(null,d);let l=u||null;if(null===l){const m=f.createEditor({customGetAdjacentNode:a.customGetAdjacentNode,editable:a.editable,html:y,namespace:k,nodes:v,onError:A=>w(A,m),theme:d});t(m,x);l=m}return[l,z]},[]);q(()=>{let d=a.editable,[k]=b;k.setEditable(void 0!==d?d:!0)},[]);return h.createElement(e.LexicalComposerContext.Provider,
{value:b},c)}
